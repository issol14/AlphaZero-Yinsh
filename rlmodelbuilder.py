...
class RLModelBuilder:
    """ 
    This class builds the neural network architecture for Yinsh based on the AlphaGo paper.
    """

    def __init__(self, input_shape: tuple, output_shape: tuple):
        """ 
        A neural network f that takes as input the Yinsh board representation and its history. 
    ...
    def build_policy_head(self) -> Model:
        ...
        model.add(Conv2D(2, kernel_size=(1, 1), strides=(1, 1), 
                        input_shape=(self.input_shape[0], self.input_shape[1], self.convolution_filters), 
...
if __name__ == "__main__":
    # parse arguments
    parser = argparse.ArgumentParser(description='Create the neural network for Yinsh')
